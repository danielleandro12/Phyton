#Exercícios funções (Fazer até o 5 apenas!!!!):
...
#        print(letras)
#        contador += 1
#    print(f'O total de letras: {contador}')
#contador_letras()    
...
def somlist(lista):
    print(lista)
listanum = [56 ,78 ,90 ,40 ,100]
soma_da_lista = sum(listanum)    
print(soma_da_lista)
...
# Adicionando o exemplo na lista de veiculos
veiculos.append(v_exemplo)


# Mas agora quero fazer isso com o usuário informando valores...
